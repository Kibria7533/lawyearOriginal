...
const QuestionOrDocumentAlertTemplate = ({ queryString }) => {
  ...
  <html xmlns="http://www.w3.org/1999/xhtml">
    <head>
      ...
      <title>You have a reminder from your lawyer</title>
      <style type="text/css">
      ...
      >
        ...
        <div class="content" style="width: 95%; margin: auto; padding: 15px">
          <p style="font-size: 16px; margin-bottom: 30px; font-weight: bold">
            You have a reminder from your lawyer. Please signin to Dossier Direct and give the information.
          </p>
          <a
            class="btn"
            href="${link}"
...
module.exports = QuestionOrDocumentAlertTemplate;
